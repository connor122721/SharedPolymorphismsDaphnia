...
options_file="/scratch/csm6hg/phd/moments/optimizedRuns_moments_rescaleNe90.txt"
script_file="/scratch/csm6hg/phd/moments/4c.save_and_analyze_sfss_historicNe.py"
