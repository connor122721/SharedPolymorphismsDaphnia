...
# Working directory: SLURM_ARRAY_TASK_ID=1600
...
options_file="/scratch/csm6hg/phd/moments/optimizedRuns_moments_rescaleNe80.txt"
script_file="/scratch/csm6hg/phd/moments/4d.save_and_analyze_sfss_historicNe.py"
