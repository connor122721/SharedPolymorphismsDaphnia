...
# Working directory: SLURM_ARRAY_TASK_ID=17
cd /scratch/csm6hg/phd/moments/
...
options_file="/scratch/csm6hg/phd/moments/optimizedRuns_moments.txt"
script_file="/scratch/csm6hg/phd/moments/3.save_and_analyze_sfss_historicNe_array.py"
