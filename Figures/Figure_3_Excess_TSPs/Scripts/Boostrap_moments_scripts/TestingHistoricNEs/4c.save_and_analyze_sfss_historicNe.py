...
csv_dir = dir + "sfss/sfs_csvs_rescale90/"
...
# Output file
output_file = dir + "output_eSMC/sfs_eSMC_rescaled90_statistics" + "." + modeli + "." + repli + ".txt"
...
with open(output_file, "a") as fout:
    ...
    for ns in [[20, 20], [100, 100]]:
        ...
        # Conditional run "Split + Migration" model
        if modeli == "split_mig":
        ...
        # Conditional run "Split + No Migration" model
