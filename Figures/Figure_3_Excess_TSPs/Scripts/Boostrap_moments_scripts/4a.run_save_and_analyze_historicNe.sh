...
# Working directory: SLURM_ARRAY_TASK_ID=10
...
options_file="/scratch/csm6hg/phd/moments/optimizedRuns_moments_rescaleNe10.txt"
script_file="/scratch/csm6hg/phd/moments/4a.save_and_analyze_sfss_historicNe.py"
