...
#i="Scaffold_1863_HRSCAF_2081 961720 962720 exon Daphnia07049-RA"
...
# VCF functions
analy="--weir-fst-pop species.pulex.nam.150samps_can.pop.fst.txt \
--weir-fst-pop species.pulex.nam.150samps_usa.pop.fst.txt --fst-window-size ${len}"

# Output name
out_namey="nam_fst_nomiss"
...
>> ${wd}/fst/${out_namey}_${SLURM_ARRAY_TASK_ID}
